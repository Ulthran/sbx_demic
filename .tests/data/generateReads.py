...
A1 = Reads("A1", combine_reads([akk.sim_reads(10000, 1, 500), bfrag.sim_reads(5000, 2, 500)]))
A2 = Reads("A2", combine_reads([akk.sim_reads(10000, 5, 500), bfrag.sim_reads(5000, 10, 500)]))
B1 = Reads("B1", combine_reads([akk.sim_reads(10000, 1, 500), bfrag.sim_reads(5000, 10, 500), ecoli.sim_reads(5000, 5, 500)]))
B2 = Reads("B2", combine_reads([akk.sim_reads(10000, 2, 500), bfrag.sim_reads(5000, 5, 500), ecoli.sim_reads(5000, 5, 500)]))
B3 = Reads("B3", combine_reads([akk.sim_reads(10000, 3, 500), bfrag.sim_reads(5000, 1, 500), ecoli.sim_reads(5000, 5, 500)]))
